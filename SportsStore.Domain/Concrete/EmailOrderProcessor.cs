...
namespace SportsStore.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "zamówienie@przykladowapoczta.pl";
        public string MailFromAddress = "sklepsportowy@przykladowapoczta.pl";
        public bool UseSsl = true;
        public string Username = "UżytkownikSmtp";
        public string Password = "HasłoSmtp";
        public string ServerName = "smtp.przykladowy.pl";
